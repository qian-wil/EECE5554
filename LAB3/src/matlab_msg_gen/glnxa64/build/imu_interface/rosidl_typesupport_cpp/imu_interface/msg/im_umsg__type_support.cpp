...
static const _IMUmsg_type_support_symbol_names_t _IMUmsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, imu_interface, msg, IMUmsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, imu_interface, msg, IMUmsg)),
  }
};
...
{
  return &::imu_interface::msg::rosidl_typesupport_cpp::IMUmsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, imu_interface, msg, IMUmsg)() {
  return get_message_type_support_handle<imu_interface::msg::IMUmsg>();
}
