...
#include "imu_interface/msg/detail/im_umsg__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // rawstr
#include "rosidl_runtime_c/string_functions.h"  // rawstr
#include "sensor_msgs/msg/detail/imu__functions.h"  // imu
#include "sensor_msgs/msg/detail/magnetic_field__functions.h"  // mag_field
...
using _IMUmsg__ros_msg_type = imu_interface__msg__IMUmsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: rawstr
  {
    const rosidl_runtime_c__String * str = &ros_message->rawstr;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: rawstr
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->rawstr.data) {
      rosidl_runtime_c__String__init(&ros_message->rawstr);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->rawstr,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'rawstr'\n");
      return false;
    }
  }
...
size_t get_serialized_size_imu_interface__msg__IMUmsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IMUmsg__ros_msg_type * ros_message = static_cast<const _IMUmsg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _IMUmsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_imu_interface__msg__IMUmsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_imu_interface
size_t max_serialized_size_imu_interface__msg__IMUmsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = imu_interface__msg__IMUmsg;
    is_plain =
      (
      offsetof(DataType, rawstr) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _IMUmsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_imu_interface__msg__IMUmsg(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, imu_interface, msg, IMUmsg)() {
