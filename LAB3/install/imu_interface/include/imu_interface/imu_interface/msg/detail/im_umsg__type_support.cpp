...
{
  new (message_memory) imu_interface::msg::IMUmsg(_init);
}

void IMUmsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<imu_interface::msg::IMUmsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IMUmsg_message_member_array[4] = {
  {
    ...
    offsetof(imu_interface::msg::IMUmsg, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(imu_interface::msg::IMUmsg, imu),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(imu_interface::msg::IMUmsg, mag_field),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(imu_interface::msg::IMUmsg, rawstr),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers IMUmsg_message_members = {
  ...
  "IMUmsg",  // message name
  4,  // number of fields
  sizeof(imu_interface::msg::IMUmsg),
...
get_message_type_support_handle<imu_interface::msg::IMUmsg>()
{
  return &::imu_interface::msg::rosidl_typesupport_introspection_cpp::IMUmsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, imu_interface, msg, IMUmsg)() {
  return &::imu_interface::msg::rosidl_typesupport_introspection_cpp::IMUmsg_message_type_support_handle;
}
