...
class Metaclass_GPSmsg(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('gps_interface')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'gps_interface.msg.GPSmsg')
            logger.debug(
...
class GPSmsg(metaclass=Metaclass_GPSmsg):
    ...
    def __init__(self, **kwargs):
        ...
        self.altitude = kwargs.get('altitude', str())
    ...
    def altitude(self, value):
        if __debug__:
            assert \
                ...
                "The 'altitude' field must be of type 'str'"
    ...
    def utc(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'utc' field must be of type 'str'"
        self._utc = value
    ...
    def zone(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'zone' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._zone = value
