...
#include "gps_interface/msg/detail/gp_smsg__rosidl_typesupport_fastrtps_c.h"
...
#include "gps_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "rosidl_runtime_c/string.h"  // altitude, letter, utc
#include "rosidl_runtime_c/string_functions.h"  // altitude, letter, utc
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_gps_interface
...
using _GPSmsg__ros_msg_type = gps_interface__msg__GPSmsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: altitude
  {
    const rosidl_runtime_c__String * str = &ros_message->altitude;
  ...
  // Field name: utc
  {
    const rosidl_runtime_c__String * str = &ros_message->utc;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: altitude
  {
    ...
    if (!ros_message->altitude.data) {
      rosidl_runtime_c__String__init(&ros_message->altitude);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->altitude,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'altitude'\n");
      return false;
    }
  }
  ...
  // Field name: utc
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->utc.data) {
      rosidl_runtime_c__String__init(&ros_message->utc);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->utc,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'utc'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gps_interface
size_t get_serialized_size_gps_interface__msg__GPSmsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GPSmsg__ros_msg_type * ros_message = static_cast<const _GPSmsg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GPSmsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gps_interface__msg__GPSmsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gps_interface
size_t max_serialized_size_gps_interface__msg__GPSmsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gps_interface__msg__GPSmsg;
    is_plain =
      (
...
static size_t _GPSmsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gps_interface__msg__GPSmsg(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gps_interface, msg, GPSmsg)() {
