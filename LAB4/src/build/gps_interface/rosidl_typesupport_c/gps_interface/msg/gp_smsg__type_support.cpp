...
static const _GPSmsg_type_support_symbol_names_t _GPSmsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gps_interface, msg, GPSmsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gps_interface, msg, GPSmsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gps_interface, msg, GPSmsg)() {
  return &::gps_interface::msg::rosidl_typesupport_c::GPSmsg_message_type_support_handle;
}
