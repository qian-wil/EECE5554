...
#include "gps_interface/msg/detail/gp_smsg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gps_interface::msg::GPSmsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gps_interface::msg::GPSmsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gps_interface::msg::GPSmsg *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_gps_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<gps_interface::msg::GPSmsg>()
{
  return &gps_interface::msg::typesupport_fastrtps_cpp::_GPSmsg__handle;
}
