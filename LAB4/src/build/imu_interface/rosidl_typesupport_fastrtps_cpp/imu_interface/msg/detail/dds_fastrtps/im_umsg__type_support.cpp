...
#include "imu_interface/msg/detail/im_umsg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = imu_interface::msg::IMUmsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const imu_interface::msg::IMUmsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<imu_interface::msg::IMUmsg *>(
    untyped_ros_message);
...
{
  return &imu_interface::msg::typesupport_fastrtps_cpp::_IMUmsg__handle;
}
