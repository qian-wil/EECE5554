...
bool imu_interface__msg__im_umsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imu_interface.msg._im_umsg.IMUmsg", full_classname_dest, 33) == 0);
  }
  imu_interface__msg__IMUmsg * ros_message = _ros_message;
  {  // header
  ...
  {  // rawstr
    PyObject * field = PyObject_GetAttrString(_pymsg, "rawstr");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->rawstr, PyBytes_AS_STRING(encoded_field));
...
PyObject * imu_interface__msg__im_umsg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("imu_interface.msg._im_umsg");
  ...
  {  // rawstr
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->rawstr.data,
      strlen(ros_message->rawstr.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "rawstr", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
