...
static const _IMUmsg_type_support_symbol_names_t _IMUmsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, imu_interface, msg, IMUmsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, imu_interface, msg, IMUmsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, imu_interface, msg, IMUmsg)() {
  return &::imu_interface::msg::rosidl_typesupport_c::IMUmsg_message_type_support_handle;
}
