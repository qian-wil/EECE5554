...
bool gps_interface__msg__gp_smsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gps_interface.msg._gp_smsg.GPSmsg", full_classname_dest, 33) == 0);
  }
  gps_interface__msg__GPSmsg * ros_message = _ros_message;
  {  // header
  ...
  {  // altitude
    ...
    rosidl_runtime_c__String__assign(&ros_message->altitude, PyBytes_AS_STRING(encoded_field));
  ...
  {  // utc
    ...
    rosidl_runtime_c__String__assign(&ros_message->utc, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // zone
    ...
    ros_message->zone = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // letter
...
PyObject * gps_interface__msg__gp_smsg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gps_interface.msg._gp_smsg");
  ...
  {  // altitude
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->altitude.data,
      strlen(ros_message->altitude.data),
      "replace");
    if (!field) {
      return NULL;
    }
  ...
  {  // utc
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->utc.data,
      strlen(ros_message->utc.data),
      "replace");
    if (!field) {
      return NULL;
    }
  ...
  {  // zone
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->zone);
    {
